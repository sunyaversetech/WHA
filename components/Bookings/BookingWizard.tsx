...
//   // ─── Fetching Data ─────────────────────────────────────────────────────────
//   const { data: businessesResponse, isLoading: loadingBusinesses } =
//     useGetALLBusiness();
...
//     return (
//       businessesResponse.data.find((b) => b._id === selectedBusinessId) || null
//     );
...
//         setLockTimerText("");
//         toast.warning(
//           "Your time slot lock has expired. Please select a slot again.",
//         );
//       } else {
...
//     toast.promise(bookingMutation.mutateAsync(payload), {
...
//               {selectedBusiness
//                 ? `${selectedBusiness.business_name} • ${selectedBusiness.city_name}`
...
//                     <MapPin className="w-4 h-4 text-[#3771db]" /> Choose a
//                     Location / Salon
//                   </label>
//                   {loadingBusinesses ? (
...
//                     <Briefcase className="w-4 h-4 text-[#3771db]" /> Select a
//                     Treatment
//                   </h3>
...
//                         <div
//                           key={n}
//                           className="h-28 bg-slate-100 animate-pulse rounded-lg"
//                         />
//                       ))}
//                     </div>
...
//                                 <Clock className="w-3.5 h-3.5 text-[#3771db]" />{" "}
//                                 {srv.base_duration} min
//                               </span>
...
//                   Please choose a salon location to view the available treatment
//                   menu.
//                 </div>
//               )}
//             </div>
...
//             <div className="space-y-6 animate-fade-in">
//               <h3 className="label-wha flex items-center gap-2">
//                 <User className="w-4 h-4 text-[#3771db]" /> Choose a Service
//                 Professional
//               </h3>
...
//                 {selectedService.assigned_employees &&
//                 selectedService.assigned_employees.length > 0 ? (
...
//                   <Calendar className="w-4 h-4 text-[#3771db]" /> Pick a Date &
//                   Time
//                 </h3>
...
//                         {day.weekday}
//                       </span>
//                       <span className="text-lg font-bold mt-1 font-montserrat">
//                         {day.dayNum}
//                       </span>
//                     </button>
//                   );
...
//                     No available time slots found for the selected date and
//                     professional. Try picking a different day.
//                   </div>
//                 )}
//               </div>
...
//                       Your slot is temporarily secured. Complete the checkout
...
//                       <MapPin className="w-4 h-4 text-[#3771db]" />{" "}
//                       {selectedBusiness?.business_name}
//                     </span>
//                   </div>
...
//                     </span>
//                     <span className="font-semibold text-slate-800 flex items-center gap-1.5">
//                       <Briefcase className="w-4 h-4 text-[#3771db]" />{" "}
...
//                     </span>
//                     <span className="font-semibold text-slate-800 flex items-center gap-1.5">
//                       <Calendar className="w-4 h-4 text-[#3771db]" />{" "}
...
//                       Duration: {selectedService.base_duration} min
//                     </h4>
//                   </div>
...
//                   <span>
//                     Your slot reservation expires in{" "}
//                     <strong className="font-mono">{lockTimerText}</strong>.
//                     Please confirm before this time.
//                   </span>
//                 </div>
//               )}
//             </div>
...
//                   We have successfully confirmed your booking. A confirmation
//                   email and reminder details will be sent shortly.
//                 </p>
//               </div>
