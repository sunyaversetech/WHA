            ...
            <div
              ...
              {/* <div className="flex items-center">
                <Input
                  ...
                  className="esw-placeholder flex-1 min-w-0 bg-transparent shadow-none border focus:outline-none  focus-visible:ring-0 outline-none text-base font-medium text-[#0f0e17] p-0 focus:ring-0"
                />
                {inputValue && (
                  <button
                    onClick={(e) => {
              ...
              <div className="relative w-full">
                ...
                <Input
                  ...
                  className="pl-10 pr-8 h-10 rounded-sm border border-gray-200 bg-white focus:ring-0 focus:outline-none  focus-visible:ring-0 focus:outline-none"
                />
