...
import { Calendar } from "@/components/ui/calendar"; // Assuming standard Shadcn path
...
function GuestCounter({ title, count, onInc, onDec }: any) {
  return (
    <div className="flex items-center justify-between">
      ...
      <div className="flex items-center gap-4">
        <button
          onClick={onDec}
          className="rounded-full border p-2 hover:border-black">
