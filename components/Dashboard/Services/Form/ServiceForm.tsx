...
export function ServiceForm({ initialData }: { initialData?: IService }) {
  ...
  const handleSectionChange = async (sec: Section) => {
    await form.trigger();
    setSection(sec);
  };
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <div className="relative">
                                  <span className="absolute left-3 top-4.5 -translate-y-1/2 text-sm text-gray-400 pointer-events-none">
                                    $AUD
                                  </span>
                                  <Input
                                    {...field}
                                    ...
                                    className="pl-14 border-gray-200 focus-visible:ring-0 focus-visible:border-[#051e3a] text-[#051e3a]"
                                  />
                                </div>
                              </FormControl>
                              <FormMessage />
                        ...
                        render={({ field }) => (
                          <FormItem className="flex items-center justify-between gap-4 p-4 border border-gray-200 rounded-xl mb-3">
                            <div>
                              ...
                              <p className="text-xs text-gray-400 mt-0.5">
                                Let more than one client book this service for
                                the same time slot
                              </p>
                            </div>
                            <FormControl>
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem className="mb-3">
                              ...
                              <p className="text-xs text-gray-400 mt-1">
                                How many people can book this service at the
                                same time
                              </p>
                              <FormMessage />
                            </FormItem>
                        ...
                        render={({ field }) => (
                          <FormItem className="flex items-center justify-between gap-4 p-4 border border-gray-200 rounded-xl">
                            <div>
                              ...
                              <p className="text-xs text-gray-400 mt-0.5">
                                Once the booking limit is reached, this service
              ...
              {section === "availability" && (
                <>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400 mb-5">
                      Set when this service / resource is available for booking
                    </p>
                            ...
                            {[
                              {
                                ...
                                desc: "Can be booked at any time",
                              },
                              {
                                value: "specific",
                                label: "Only on specific days / times",
                                desc: "Set custom hours for each day of the week",
                              },
                            ].map((opt) => (
                              <button
                                key={opt.value}
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400 mb-5">
                      How many bookings can this resource handle at the same
                      time
                    </p>
                      ...
                      render={({ field }) => (
                        <FormItem className="flex items-center justify-between gap-4 p-4 border border-gray-200 rounded-xl mb-3">
                          <div>
                            ...
                            <p className="text-xs text-gray-400 mt-0.5">
                              Let more than one client use this resource at the
                              same time
                            </p>
                          </div>
                          <FormControl>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <p className="text-xs text-gray-400 mt-1">
                              Maximum number of simultaneous bookings for this
                              resource
                            </p>
                            <FormMessage />
                          </FormItem>
